...
void LOGIC_GATES_body__(LOGIC_GATES *data__) {
  ...
  __SET_VAR(data__->,OUTPUT_0,,!(__GET_VAR(data__->INPUT_0,)));
  __SET_VAR(data__->,OUTPUT_1,,(__GET_VAR(data__->INPUT_1,) || __GET_VAR(data__->INPUT_2,)));
  __SET_VAR(data__->,OUTPUT_2,,(!(__GET_VAR(data__->INPUT_4,)) && !(__GET_VAR(data__->INPUT_3,))));
