...
void XOR_AND_XNOR_body__(XOR_AND_XNOR *data__) {
  ...
  __SET_VAR(data__->,OUTPUT_0,,((!(__GET_VAR(data__->INPUT_0,)) && __GET_VAR(data__->INPUT_1,)) || (!(__GET_VAR(data__->INPUT_1,)) && __GET_VAR(data__->INPUT_0,))));
  __SET_VAR(data__->,OUTPUT_1,,((__GET_VAR(data__->INPUT_3,) && __GET_VAR(data__->INPUT_2,)) || (!(__GET_VAR(data__->INPUT_3,)) && !(__GET_VAR(data__->INPUT_2,)))));
